...
# starts the app on http://127.0.0.1:8000 and opens it in your browser. This
# Terminal window is the app: keep it open while you use PhD Tracker, and close
# it to quit.
...
if lsof -nP -iTCP:8000 -sTCP:LISTEN >/dev/null 2>&1; then
  ...
  alert "Another program is using port 8000, so PhD Tracker can't start. Quit that program and try again."
  exit 1
fi
...
exec "$PY" -m uvicorn app.main:app --host 127.0.0.1 --port 8000 --no-access-log
