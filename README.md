...
all of the steps below, including the Claude sign-in. It puts the app in a
"PhD Tracker" folder on the Desktop, where "Open PhD Tracker" and "Update PhD
Tracker" carry the app's icon. How to run it is in the comment at the top of
the file, and it's safe to run again.
